// 01_ 비교연산자
// 비교연산자는 좌향과 우향의 비교 연산자를 비교한 다음 그 결과를 불리연 값으로 반환한다.
//if문이나 for문과 같은 제어문의 조건식에서 주로 사용한다.

//동등/일치 비교 연산자
//동등 비교 연산자와 일치 비교 연산자는 비교하는 엄격성의 정도가 다르다.
//동등 비교(== !=) 연산자는 먼저 암묵적 타입 변환을 통해 타입을 일치시킨 후 같은 값이닞 비교한다.
// 일치 비교(=== !==) 연산자 타입과 값이 모두 일치하는지 비교하낟.
...
//일치 비교 연산
console.log(`'hellow' === 'hellow' : ${'hellow' === 'hellow'}`);
console.log(`'hellow' !== 'hellow' : ${'hellow' !== 'hellow'}`);
