// 일반적인 의미의 배열은 각 요소가 동일한 데이터 크기를 가지며, 빈틈없이 연속적으로 이어져 있어 인덱스를 통해
// 임의ㅡ이 요소에 한번에 접근 할 수 있는 고속 동작을 장점으로한다.
...
// 프로퍼티 플래그
// 객체 프로퍼티는 값(value)과 함께 속성의 행동을 제어하는 플래그(flag)하 불리는 특별한 속성 세가지를 가짐
//writable - true이면 값을 수정할 수 있다. 그렇지 않다면 읽기만 가능하다.
//enumenable - true이면 반복문을 사용해 나열할 수 있다. 그렇지 않다면 반복문을 사용해 나열할 수 없다.
